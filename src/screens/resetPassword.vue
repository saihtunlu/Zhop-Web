      ...
      <div class="row logIn-popup big-radius mt-3 shadow bg-theme">
        ...
        <div class="col-lg-6 sign_content pl-lg-4 py-4">
          <div class="vx-card__title mb-3">
            <h4 class="mb-3 transparent_text caption text-center upper">Reset Password</h4>
          ...
          <form @submit.prevent="reset" class="sign_form">
            ...
            />
            <vs-input
              :danger="user.password_confirmation_field"
            ...
            <div class="sign_btns">
              ...
              >
                <span class="vs-button-text vs-button--text">Reset Password</span>
                <vs-icon
  ...
  methods: {
    checkPassword() {
      if (this.user.password !== this.user.password_confirmation) {
        ...
        this.error_message = "Password confirmation does not match.";
        return false;
      } else {
    ...
    reset() {
      ...
      if (!this.user.email) {
        this.user.email_field = true;
        return false;
      }
      if (!this.user.password) {
        this.user.password_field = true;
        return false;
      }
      if (!this.user.password_confirmation) {
        this.user.password_confirmation_field = true;
        return false;
      }
      ...
      this.$axios
        ...
        .then((response) => {
          ...
          this.$vs.notify({
            title: "Success",
            text:
              "Your password has been successfully changed. You can now sign in with your new password. Click here to sign in.",
            color: "success",
            fixed: true,
            click: () => {
