      ...
      <div class="row logIn-popup big-radius mt-3 shadow bg-theme">
        ...
        <div class="col-lg-6 sign_content pl-lg-4 py-4">
          <div class="vx-card__title mb-3">
            <h4 class="mb-3 transparent_text caption text-center upper">Recover your password</h4>
            <p
              class="text-center"
            >Please enter your email address and we'll send you instructions on how to reset your password.</p>
          </div>
          <vs-alert
            color="success"
            :active.sync="success"
          ...
          <vs-alert
            ...
            close-icon="close"
          >{{ email_message }}</vs-alert>
          <form @submit.prevent="send" class="sign_form">
            <vs-input
              :danger="email_field"
  ...
  methods: {
    send() {
      ...
      this.$axios
        ...
        .catch((error) => {
          console.log(
            "Forgot -> handleForgot -> error",
            error.response.data.error
          );
          this.email_message = error.response.data.error;
          this.error = true;
          this.loading = false;
        });
    },
